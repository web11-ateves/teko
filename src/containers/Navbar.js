...
const Navbar = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <a href="hhttps://testnets.opensea.io/collection/refugio-da-ilha-membership"><img className={styles.oplogo2} src={images.oplogo}/></a>
      <div className={styles.sidebar}>
         <div className={styles.oplogo}>
         <a href="https://testnets.opensea.io/collection/refugio-da-ilha-membership"><img  src={images.oplogo}/></a>
      </div>      
